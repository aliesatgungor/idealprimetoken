...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function ERC20Token(
        ...
        balances[msg.sender] = 300000;               // Oluşturana gönderilecek token miktarı (Örnek :100000)
        totalSupply = 300000;                        // Toplam arzı güncelleme (Örnek:100000)
        name = "Ideal Prime Token";                                   // Set the name for display purposes
        decimals = 0;                            // Ondalık Sayısı
        symbol = "IDL";                               // Jetonun Sembolü 4 Harf Geçmemesi Önerilir
    }
